...
%\input{1_Introduction}
	...
	\cleardoublepage
	\pagestyle{mystyle}
\input{2_Chapter_1_TheoreticalBackground}

	\cleardoublepage
	\pagestyle{mystyle}
\input{3_Chapter_2_Data}

	\cleardoublepage
	\pagestyle{mystyle}
\input{4_Chapter_3_TES}

	\cleardoublepage
	\pagestyle{mystyle}
\input{5_Chapter_4_OSTES_valid}

	\cleardoublepage
	\pagestyle{mystyle}
\input{6_Chapter_5_GroundMeasurements}

%% zaver
	\cleardoublepage
	\pagestyle{myzaver}
\input{7_Chapter_6_Conclusion}

\cleardoublepage
%% dodatky
\pagestyle{mydodatky}
\input{9_Appendix_1_Library}
